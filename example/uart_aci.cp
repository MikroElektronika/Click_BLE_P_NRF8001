#line 1 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
...
#line 39 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
char txt[20];
#line 43 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
struct aci_state_t aci_state;
#line 49 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
static hal_aci_evt_t aci_data;
#line 55 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
static  _Bool  timing_change_done =  0 ;
#line 60 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
static uart_over_ble_t uart_over_ble;


void __ble_assert(const char *file, uint16_t line)
{
  UART1_Write("BLE UART ERROR") ;
  UART1_Write(file) ;
  UART1_Write(": ") ;
  UART1_Write(line) ;
  UART1_Write("\n") ;
 ...
 _Bool  uart_process_control_point_rx(uint8_t *byte, uint8_t length)
{
 ...
 if (lib_aci_is_pipe_available(&aci_state,  10 ) )
 {
  ;
 switch(*byte)
 {
#line 89 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 case  (0x01) :
#line 94 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 lib_aci_disconnect(&aci_state, ACI_REASON_TERMINATE);
 status =  1 ;
 break;
#line 102 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 case  (0x02) :
#line 112 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 ...
 status =  1 ;
 break;
#line 123 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 case  (0x03) :
#line 128 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 uart_over_ble.uart_rts_local =  0 ;
 status =  1 ;
 break;
#line 136 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 case  (0x04) :
#line 141 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 uart_over_ble.uart_rts_local =  1 ;
 status =  1 ;
 break;
 }
 }
...
void aci_loop()
{
 ...
 {
#line 164 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
...
#line 173 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 ...
 lib_aci_set_local_data(&aci_state,  3 ,
...
#line 229 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 lib_aci_device_version();
 break;

 case ACI_EVT_PIPE_STATUS:
 UART1_Write_Text(" Evt Pipe Status ");
 if (lib_aci_is_pipe_available(&aci_state,  9 ) && ( 0  == timing_change_done))
 {
 ...
 if ( 8  == aci_evt->params.data_received.rx_data.pipe_number)
 {

 ble_uart_rx(&aci_evt->params.data_received.rx_data.aci_data[0], aci_evt->len - 2);
 }
 if ( 11  == aci_evt->params.data_received.rx_data.pipe_number)
 {
 ...
 {
  UART1_Write(aci_evt->params.hw_error.file_name[counter]) ;
 }
 UART1_Write_Text("\n");
 lib_aci_connect(0 , 0x0050 );
 UART1_Write_Text(" Advertising started. Tap Connect on the nRF UART app ");
...
#line 325 "C:/Users/Viktor/Desktop/ble_blog_release/example/uart_aci.c"
 if(setup_required)
 {
 if ( 0  == do_aci_setup(&aci_state))
 {
 setup_required =  0 ;
 }
 }
