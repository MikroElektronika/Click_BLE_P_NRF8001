#line 1 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
...
#line 39 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
extern hal_aci_data_t msg_to_send;
#line 51 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
static  _Bool  aci_setup_fill(aci_state_t *aci_stat, uint8_t *num_cmd_offset)
{
  _Bool  ret_val =  0 ;

 while (*num_cmd_offset < aci_stat->aci_setup_info.num_setup_msgs)
 {
#line 69 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
...
uint8_t do_aci_setup(aci_state_t *aci_stat)
{
 ...
 uint32_t i = 0x0000;
 aci_evt_t * aci_evt =  ((void *)0) ;
 aci_status_code_t cmd_status = ACI_STATUS_ERROR_CRC_MISMATCH;
#line 100 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
 hal_aci_evt_t *aci_data = (hal_aci_evt_t *)&msg_to_send;
#line 106 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
 if (!lib_aci_command_queue_empty())
 {
 return  1 ;
 }
#line 115 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
 ...
 {
#line 129 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
 if (i++ > 0xFFFFE)
 {
 return  3 ;
 }
 ...
 i = 0;
#line 154 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
 aci_setup_fill(aci_stat, &setup_offset);
 break;
...
#line 170 "C:/Users/Viktor/Desktop/ble_blog_release/src/aci_setup.c"
